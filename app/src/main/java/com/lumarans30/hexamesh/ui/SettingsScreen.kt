...
fun settingsScreen(
    ...
    Column(
        ...
        routerModeCard(routerMode = routerMode, onChange = onRouterModeChange)
...
@Composable
private fun routerModeCard(routerMode: Boolean, onChange: (Boolean) -> Unit) {
    Surface(
        ...
        Row(
            ...
            Switch(checked = routerMode, onCheckedChange = onChange)
        }
    }
}
